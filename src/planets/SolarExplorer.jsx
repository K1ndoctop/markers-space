      ...
      <body className="body_space">
            ...
            <div className="planet mars">
              ...
              <div className="planet_description mars">
                ...
                <p>
                  ...
                  the solar systm. Named after the Roman god of war often
          ...
          <div className="solar_systm">
            <div className="planet jupiter">
              ...
              <div className="planet_description jupiter">
                ...
                <h1>Jupiter</h1>
                <p>
                  Jupiter is the largest planet in the solar systm. Fittingly,
            ...
            <div className="planet saturn">
              ...
              <div className="planet_description saturn">
                ...
                <p>
                  ...
                  planet in the solar systm. Saturn was the Roman name for
        ...
        <div className="panel">
          ...
          <p>
            ...
            two names referred to the same body, and Heraclitus, around 500
        ...
        <div className="panel">
          ...
          <p>
            ...
            sun, is now the largest known dwarf planet in the solar systm. It is
            also one of the largest known members of the Kuiper Belt, a shadowy
            zone beyond the orbit of Neptune thought to be populated by hundreds
            of thousands of rocky, icy bodies each larger than 62 miles (100
          ...
          <p>
            ...
            attracted controversy and stirred debate in the scientific
            ...
            space smaller than stars," which would make the number of planets in
            our solar systm expand from 8 to roughly 100.
          </p>
          <img
          ...
          <p>
            This is a later name for the more well known Hades and was proposed
            by Venetia Burney an eleven year old schoolgirl from Oxford,
            England.
          </p>
          <h2>
          ...
          <p>
            ...
            reclassified as a dwarf planet it completed under a third of its
